...
<input type="button" value="Vaccine Record" onclick="window.location='vac.php'">
...
$result = mysql_query("SELECT contact,count(*) as total FROM users GROUP BY address");
while($row = mysql_fetch_array($result))
{
	 $birthDate = $row['contact'];
