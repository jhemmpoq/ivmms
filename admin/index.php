...
?>
		 ...
		 <form action="rex.php" method="POST">
		  <h3 style="margin:0px">Add Child Information</h2>
		  Name:<br>
...
while($row = mysql_fetch_array($result))
{
			...
			echo '<td width="35%"><center><a href="v1.php?id='.$row["id"].'">View Vaccination Record</a> | <a href="update.php?id='.$row["id"].'">Edit</a> |<a href="delete.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this record? Press OK to continue\')">Delete</a></td>';
			echo '</tr>';
}
?>
...
<div class="row-fluid">
  <div id="footer" class="span12"> 2021 - IVMMS: Management and Monitoring System of Immunization Vaccine in the Municipality of Mabini </div>
</div>
